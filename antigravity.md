# Thoughts on using Antigravity for this project

> First thought when writing this: there must be away to turn of AI-autocompletion for specific files. Having antigravity suggest stuff when I am reviewing it is not a good idea. I am switching to Vim for this particular file.

My main interest in testing Antigravity for this project is finding out if it can actually help me write stuff that I know I can write myself, but in a domain that I am only semi-comfortable. 

## First thoughts while half-way through the project
